...
const educationData = [
  {
    ...
    course: "Analise e densevolvimento de sistemas",
    period: "2024 Jan - 2025 Dez",
    status: "Cursando",
    icon: GraduationCap,
  ...
  //   status: "Concluído",
  //   icon: BookOpen,
  //   description: "Fundamentos de programação, redes e manutenção de computadores.",
  // },
  {
    type: "Ensino Médio",
    institution: "Colégio Estadual Joao Afonso de Camargo ",
